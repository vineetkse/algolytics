...
CREATE TABLE "new_UserProgress" (
    ...
    "mockInterviews" TEXT NOT NULL DEFAULT '[]',
...
INSERT INTO "new_UserProgress" ("correctDrills", "id", "lastTrainedAt", "patternMastery", "problemProgress", "profileId", "sessions", "streak", "totalDrills", "updatedAt") SELECT "correctDrills", "id", "lastTrainedAt", "patternMastery", "problemProgress", "profileId", "sessions", "streak", "totalDrills", "updatedAt" FROM "UserProgress";
